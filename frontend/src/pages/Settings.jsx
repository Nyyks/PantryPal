  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        />
        <Toggle
          label="Show Variants in Main Row"
          description="Show barcode variant labels (e.g. Coop, Migros) directly in the inventory table row. They always appear in the expanded dropdown."
          checked={prefs.show_variants_in_row}
          onChange={v => updatePref('show_variants_in_row', v)}
        />
